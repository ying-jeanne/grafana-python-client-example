...
class AnnotationsApi(object):
    ...
    def create_annotation(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_annotation(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PostAnnotationsCmdModel body: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_annotation_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_annotation_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_annotation_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create Annotation.  # noqa: E501

        Creates an annotation in the Grafana database. The dashboardId and panelId fields are optional. If they are not specified then an organization annotation is created and can be queried in any dashboard that adds the Grafana annotations data source. When creating a region annotation include the timeEnd property. The format for `time` and `timeEnd` should be epoch numbers in millisecond resolution. The response for this HTTP request is slightly different in versions prior to v6.4. In prior versions you would also get an endId if you where creating a region. But in 6.4 regions are represented using a single event with time and timeEnd properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_annotation_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='InlineResponse2003Model',  # noqa: E501
    ...
    def create_graphite_annotation(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_graphite_annotation(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PostGraphiteAnnotationsCmdModel body: (required)
        :return: InlineResponse2003Model
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_graphite_annotation_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_graphite_annotation_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_graphite_annotation_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create Annotation in Graphite format.  # noqa: E501

        Creates an annotation by using Graphite-compatible event format. The `when` and `data` fields are optional. If `when` is not specified then the current time will be used as annotation’s timestamp. The `tags` field can also be in prior to Graphite `0.10.0` format (string with multiple tags being separated by a space).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_graphite_annotation_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_graphite_annotation" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `create_graphite_annotation`")  # noqa: E501
    ...
    def delete_annotation(self, annotation_id, **kwargs):  # noqa: E501
        """Delete Annotation By ID.  # noqa: E501

        Deletes the annotation that matches the specified ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_annotation(annotation_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_annotation_with_http_info(annotation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_annotation_with_http_info(annotation_id, **kwargs)  # noqa: E501
            return data

    def delete_annotation_with_http_info(self, annotation_id, **kwargs):  # noqa: E501
        """Delete Annotation By ID.  # noqa: E501

        Deletes the annotation that matches the specified ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_annotation_with_http_info(annotation_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_annotation_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ItemDTOModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_annotation_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetAnnotationTagsResponseModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_annotations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['_from', 'to', 'user_id', 'alert_id', 'dashboard_id', 'panel_id', 'limit', 'tags', 'type', 'match_any']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[ItemDTOModel]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def mass_delete_annotations(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param MassDeleteAnnotationsCmdModel body: (required)
        :return: SuccessResponseBodyModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def patch_annotation(self, annotation_id, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str annotation_id: (required)
        :param PatchAnnotationsCmdModel body: (required)
        :return: SuccessResponseBodyModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_annotation(self, annotation_id, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str annotation_id: (required)
        :param UpdateAnnotationsCmdModel body: (required)
        :return: SuccessResponseBodyModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
