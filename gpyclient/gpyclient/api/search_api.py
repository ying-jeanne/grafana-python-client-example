...
class SearchApi(object):
    ...
    def search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['query', 'tag', 'type', 'dashboard_ids', 'folder_ids', 'starred', 'limit', 'page', 'permission', 'sort']  # noqa: E501
        ...
        if 'dashboard_ids' in params:
            ...
            collection_formats['dashboardIds'] = 'csv'  # noqa: E501
        if 'folder_ids' in params:
            query_params.append(('folderIds', params['folder_ids']))  # noqa: E501
            collection_formats['folderIds'] = 'csv'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='HitListModel',  # noqa: E501
    ...
    def search_sorting(self, **kwargs):  # noqa: E501
        """search_sorting  # noqa: E501

        List search sorting options  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_sorting(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_sorting_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.search_sorting_with_http_info(**kwargs)  # noqa: E501
            return data

    def search_sorting_with_http_info(self, **kwargs):  # noqa: E501
        """search_sorting  # noqa: E501

        List search sorting options  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_sorting_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InlineResponse20012Model',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
