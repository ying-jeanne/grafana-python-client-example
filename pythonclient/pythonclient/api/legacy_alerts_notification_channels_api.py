...
class LegacyAlertsNotificationChannelsApi(object):
    ...
    def create_alert_notification_channel(self, body, **kwargs):  # noqa: E501
        ...
        :param CreateAlertNotificationCommandModel body: (required)
    ...
    def create_alert_notification_channel_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='AlertNotificationModel',  # noqa: E501
    ...
    def delete_alert_notification_channel_by_uid_with_http_info(self, notification_channel_uid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InlineResponse2001Model',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_alert_notification_channels(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: list[AlertNotificationModel]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_alert_notification_channels_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[AlertNotificationModel]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def lookup_alert_notification_channels(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lookup_alert_notification_channels(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[AlertNotificationLookupModel]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.lookup_alert_notification_channels_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.lookup_alert_notification_channels_with_http_info(**kwargs)  # noqa: E501
            return data

    def lookup_alert_notification_channels_with_http_info(self, **kwargs):  # noqa: E501
        """Get all notification channels (lookup)  # noqa: E501

        Returns all notification channels, but with less detailed information. Accessible by any authenticated user and is mainly used by providing alert notification channels in Grafana UI when configuring alert rule.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lookup_alert_notification_channels_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method lookup_alert_notification_channels" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[AlertNotificationLookupModel]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def notification_channel_test(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param NotificationTestCommandModel body: (required)
        :return: SuccessResponseBodyModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_alert_notification_channel(self, notification_channel_id, body, **kwargs):  # noqa: E501
        """Update notification channel by ID.  # noqa: E501

        Updates an existing notification channel identified by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_alert_notification_channel(notification_channel_id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int notification_channel_id: (required)
        :param UpdateAlertNotificationCommandModel body: (required)
        :return: AlertNotificationModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_alert_notification_channel_with_http_info(notification_channel_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_alert_notification_channel_with_http_info(notification_channel_id, body, **kwargs)  # noqa: E501
            return data

    def update_alert_notification_channel_with_http_info(self, notification_channel_id, body, **kwargs):  # noqa: E501
        """Update notification channel by ID.  # noqa: E501

        Updates an existing notification channel identified by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_alert_notification_channel_with_http_info(notification_channel_id, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['notification_channel_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_alert_notification_channel_byuid(self, notification_channel_uid, body, **kwargs):  # noqa: E501
        """Update notification channel by UID.  # noqa: E501

        Updates an existing notification channel identified by uid.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_alert_notification_channel_byuid(notification_channel_uid, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str notification_channel_uid: (required)
        :param UpdateAlertNotificationWithUidCommandModel body: (required)
        :return: AlertNotificationModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_alert_notification_channel_byuid_with_http_info(notification_channel_uid, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_alert_notification_channel_byuid_with_http_info(notification_channel_uid, body, **kwargs)  # noqa: E501
            return data

    def update_alert_notification_channel_byuid_with_http_info(self, notification_channel_uid, body, **kwargs):  # noqa: E501
        """Update notification channel by UID.  # noqa: E501

        Updates an existing notification channel identified by uid.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_alert_notification_channel_byuid_with_http_info(notification_channel_uid, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['notification_channel_uid', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_alert_notification_channel_byuid" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'notification_channel_uid' is set
        if self.api_client.client_side_validation and ('notification_channel_uid' not in params or
                                                       params['notification_channel_uid'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `notification_channel_uid` when calling `update_alert_notification_channel_byuid`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `update_alert_notification_channel_byuid`")  # noqa: E501
