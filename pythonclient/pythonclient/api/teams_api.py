...
class TeamsApi(object):
    ...
    def add_team_member(self, team_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_team_member(team_id, async_req=True)
        >>> result = thread.get()
    ...
    def add_team_member_with_http_info(self, team_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_team_member_with_http_info(team_id, async_req=True)
        >>> result = thread.get()
    ...
    def create_team(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param CreateTeamCommandModel body: (required)
    ...
    def create_team_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InlineResponse20015Model',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_team_with_http_info(self, team_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TeamDTOModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_team_preferences_with_http_info(self, team_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PrefsModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search_teams_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SearchTeamQueryResultModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_team(self, team_id, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str team_id: (required)
        :param UpdateTeamCommandModel body: (required)
        :return: SuccessResponseBodyModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_team_with_http_info(team_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_team_with_http_info(team_id, body, **kwargs)  # noqa: E501
            return data

    def update_team_with_http_info(self, team_id, body, **kwargs):  # noqa: E501
        """Update Team.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_team_with_http_info(team_id, body, async_req=True)
        >>> result = thread.get()
    ...
    def update_team_member(self, team_id, body, user_id, **kwargs):  # noqa: E501
        """Update Team Member.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_team_member(team_id, body, user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str team_id: (required)
        :param UpdateTeamMemberCommandModel body: (required)
        :param int user_id: (required)
        :return: SuccessResponseBodyModel
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_team_member_with_http_info(team_id, body, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_team_member_with_http_info(team_id, body, user_id, **kwargs)  # noqa: E501
            return data

    def update_team_member_with_http_info(self, team_id, body, user_id, **kwargs):  # noqa: E501
        """Update Team Member.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_team_member_with_http_info(team_id, body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['team_id', 'body', 'user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_team_preferences(self, team_id, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str team_id: (required)
        :param UpdatePrefsCmdModel body: (required)
        :return: SuccessResponseBodyModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
