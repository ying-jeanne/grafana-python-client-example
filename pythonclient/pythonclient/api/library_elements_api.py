...
class LibraryElementsApi(object):
    ...
    def create_library_element(self, body, **kwargs):  # noqa: E501
        ...
        :param CreateLibraryElementCommandModel body: (required)
    ...
    def create_library_element_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LibraryElementResponseModel',  # noqa: E501
    ...
    def get_library_element_connections_with_http_info(self, library_element_uid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LibraryElementConnectionsResponseModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_library_elements_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LibraryElementSearchResponseModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_library_element(self, library_element_uid, body, **kwargs):  # noqa: E501
        """Update library element.  # noqa: E501

        Updates an existing library element identified by uid.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_library_element(library_element_uid, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str library_element_uid: (required)
        :param PatchLibraryElementCommandModel body: (required)
        :return: LibraryElementResponseModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_library_element_with_http_info(library_element_uid, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_library_element_with_http_info(library_element_uid, body, **kwargs)  # noqa: E501
            return data

    def update_library_element_with_http_info(self, library_element_uid, body, **kwargs):  # noqa: E501
        """Update library element.  # noqa: E501

        Updates an existing library element identified by uid.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_library_element_with_http_info(library_element_uid, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['library_element_uid', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
