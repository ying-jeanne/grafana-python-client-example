...
class SignedInUserApi(object):
    ...
    def change_user_password(self, body, **kwargs):  # noqa: E501
        ...
        :param ChangeUserPasswordCommandModel body: To change the email, name, login, theme, provide another one. (required)
    ...
    def clear_help_flags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InlineResponse20016Model',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_signed_in_user_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='UserProfileDTOModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_signed_in_user_auth_tokens(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_signed_in_user_auth_tokens(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_signed_in_user_auth_tokens_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_signed_in_user_auth_tokens_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_signed_in_user_auth_tokens_with_http_info(self, **kwargs):  # noqa: E501
        """Auth tokens of the actual User.  # noqa: E501

        Return a list of all auth tokens (devices) that the actual user currently have logged in from.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_signed_in_user_auth_tokens_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_signed_in_user_auth_tokens" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_signed_in_user_org_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[UserOrgDTOModel]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def revoke_signed_in_auth_token_cmd(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revoke_signed_in_auth_token_cmd(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.revoke_signed_in_auth_token_cmd_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.revoke_signed_in_auth_token_cmd_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def revoke_signed_in_auth_token_cmd_with_http_info(self, body, **kwargs):  # noqa: E501
        """Revoke an auth token of the actual User.  # noqa: E501

        Revokes the given auth token (device) for the actual user. User of issued auth token (device) will no longer be logged in and will be required to authenticate again upon next activity.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revoke_signed_in_auth_token_cmd_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method revoke_signed_in_auth_token_cmd" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `revoke_signed_in_auth_token_cmd`")  # noqa: E501
    ...
    def update_signed_in_user(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UpdateUserCommandModel body: To change the email, name, login, theme, provide another one. (required)
        :return: UserProfileDTOModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
