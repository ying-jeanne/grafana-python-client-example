...
class DashboardsApi(object):
    ...
    def calc_dashboard_diff(self, body, **kwargs):  # noqa: E501
        """Perform diff on two dashboards.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.calc_dashboard_diff(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BodyModel body: (required)
        :return: list[int]
        ...
        if kwargs.get('async_req'):
            return self.calc_dashboard_diff_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.calc_dashboard_diff_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def calc_dashboard_diff_with_http_info(self, body, **kwargs):  # noqa: E501
        """Perform diff on two dashboards.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.calc_dashboard_diff_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method calc_dashboard_diff" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('body' not in params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `calc_dashboard_diff`")  # noqa: E501
    ...
    def delete_dashboard_by_uid_with_http_info(self, uid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InlineResponse2005Model',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_dashboard_by_uid(self, uid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str uid: (required)
        :return: DashboardFullWithMetaModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_dashboard_by_uid_with_http_info(self, uid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DashboardFullWithMetaModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_dashboard_tags(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: list[DashboardTagCloudItemModel]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_dashboard_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[DashboardTagCloudItemModel]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_home_dashboard(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :return: GetHomeDashboardResponseModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_home_dashboard_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetHomeDashboardResponseModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def import_dashboard(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ImportDashboardRequestModel body: (required)
        :return: ImportDashboardResponseModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def import_dashboard_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ImportDashboardResponseModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_dashboard(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param SaveDashboardCommandModel body: (required)
    ...
    def trim_dashboard(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param TrimDashboardCommandModel body: (required)
        :return: TrimDashboardFullWithMetaModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def trim_dashboard_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TrimDashboardFullWithMetaModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
