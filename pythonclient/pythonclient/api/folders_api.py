...
class FoldersApi(object):
    ...
    def create_folder(self, body, **kwargs):  # noqa: E501
        ...
        :param CreateFolderCommandModel body: (required)
        :return: FolderModel
    ...
    def create_folder_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='FolderModel',  # noqa: E501
    ...
    def delete_folder_with_http_info(self, folder_uid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InlineResponse2009Model',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_folders(self, **kwargs):  # noqa: E501
        ...
        :return: list[FolderSearchHitModel]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_folders_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[FolderSearchHitModel]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_folder(self, folder_uid, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str folder_uid: (required)
        :param UpdateFolderCommandModel body: To change the unique identifier (uid), provide another one. To overwrite an existing folder with newer version, set `overwrite` to `true`. Provide the current version to safelly update the folder: if the provided version differs from the stored one the request will fail, unless `overwrite` is `true`. (required)
        :return: FolderModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
